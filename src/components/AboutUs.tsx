      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row md:gap-16 gap-8">
          ...
          <div className="w-full md:max-w-[480px] pt-4 md:pt-16">
            <div className="border-b-2 border-gray-300 pb-4 md:pb-6 mb-6 md:mb-10">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <button className="bg-[#A05EB5] text-white px-6 md:px-8 py-2 rounded-md text-[14px] md:text-[15px] mt-4">
                Learn More
              </button>
            </div>
          </div>
